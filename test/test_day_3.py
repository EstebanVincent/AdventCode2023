import unittest
from day_3.solve import read_file, solve_part_1, solve_part_2


class Test_Day3(unittest.TestCase):
    def setUp(self):
        # Read the input files
        self.input_lines = read_file("day_3/input.txt")
        self.example_1_lines = read_file("day_3/example_1.txt")
        self.example_2_lines = self.read_file("day_3/example_2.txt")
