...
class Test_Day2(unittest.TestCase):
    def setUp(self):
        ...
        self.input_df = read_file("day_3/input.txt")
        self.example_1_df = read_file("day_3/example_1.txt")
        self.example_2_df = self.read_file("day_3/example_2.txt")
    ...
    def test_solve_part_1_with_example_1(self):
        result = solve_part_1(self.example_1_df)
        self.assertEqual(result, 8)

    def test_solve_part_1_with_input(self):
        result = solve_part_1(self.input_df)
