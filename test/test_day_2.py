...
class Test_Day2(unittest.TestCase):
    def setUp(self):
        ...
        self.input_lines = read_file("day_2/input.txt")
        self.example_1_lines = read_file("day_2/example_1.txt")
        self.example_2_lines = self.read_file("day_2/example_2.txt")
    ...
    def test_solve_part_1_with_example_1(self):
        result = solve_part_1(self.example_1_lines, red=12, green=13, blue=14)
        self.assertEqual(result, 8)

    def test_solve_part_1_with_input(self):
        result = solve_part_1(self.input_lines, red=12, green=13, blue=14)
